...
ReturnCode[ReturnCode["SignatureArchiveHasSameSignatureFile"] = 13] = "SignatureArchiveHasSameSignatureFile"; // The signature archive has the same signature file.
...
ReturnCode[ReturnCode["SignatureArchiveHasTooManyEntries"] = 112] = "SignatureArchiveHasTooManyEntries"; // The signature archive has too many entries.
...
async function verify(vsixFilePath, signatureArchiveFilePath, verbose) {
    ...
    await execCommand(args, verbose);
    return true;
}
 ...
 */
function execCommand(args, verbose) {
