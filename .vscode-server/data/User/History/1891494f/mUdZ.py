...
class move_x(Node):
    ...
    def timer_callback(self):
        ...
        self.ball_y_rec.append(ball_y_abs)
        ...
        if (avs > 500) & (avs < 1500): # 如果球很远或者走掉了
        ...
        self.get_logger().info(f"ballyabs={ball_y_abs},avs={avs},size={size},avx={avx},origin_x={self.x_rec}")
